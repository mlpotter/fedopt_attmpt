...
if __name__ == "__main__":
    ...
    parser.add_argument('--world_size',type=int,default=6,help='The world size which is equal to 1 server + (world size - 1) clients')
    parser.add_argument('--epochs',type=int,default=3,help='The number of epochs to run on the client training each iteration')
    parser.add_argument('--iterations',type=int,default=200,help='The number of iterations to communication between clients and server')
    ...
    parser.add_argument('--client_percent',type=float,default=0.6,help='Number of clients to sample for training and update')
